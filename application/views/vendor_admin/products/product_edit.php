...
<div class="card card-primary card-outline">
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs firstLvlTabs" id="custom-content-below-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="tabs_options" data-toggle="tab" href="#options" role="tab" aria-controls="options" aria-selected="false">
                    <?= $this->lang->line('VENDOR_ADMIN_PRODUCT_EDIT_TABS_OPTIONS'); ?>
                </a>
            </li>
            <?php /*
            <li class="nav-item">
        ...
        <div class="tab-content" id="custom-content-below-tabContent">
            ...
            <div class="tab-pane fade" id="options" role="tabpanel" aria-labelledby="options-tab">
                <?php require 'tabs/edit_options.php'; ?>
            </div>
            <?php /*
